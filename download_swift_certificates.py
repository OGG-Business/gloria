...
def download_swift_root_ca():
    ...
    try:
        ...
        if swift_root_ca_issuer in issuer and swift_root_ca_subject in subject:
            print("✅ Informations officielles SWIFT confirmées")
        else:
            print("⚠️ Informations officielles SWIFT non confirmées")
