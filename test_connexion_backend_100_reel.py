...
Test de connexion réelle du backend sans simulation
"""
...
def test_connexion_backend_100_reel():
    ...
    # Test 1: Vérifier si le processus backend tourne
    ...
    # Test 3: Test HTTP réel - Endpoint root
    ...
    # Test 4: Test HTTP réel - Health endpoint
    ...
    # Test 5: Test HTTP réel - API Health endpoint
    ...
    # Test 6: Test HTTP réel - API Transfers endpoint (GET)
    ...
    # Test 7: Test HTTP réel - API Transfers endpoint (POST)
