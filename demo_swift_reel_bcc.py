...
Montre comment l'application peut envoyer des messages SWIFT réels
"""
...
class SwiftRealDemo:
    ...
    def show_transfer_details(self):
        """Affiche les détails du transfert de démonstration"""
    ...
    def show_swift_message_generation(self):
        """Montre la génération de messages SWIFT"""
...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.10">
  <FIToFICstmrCdtTrf>
    ...
    def show_real_swift_process(self):
        """Montre le processus d'envoi SWIFT réel"""
    ...
    def show_certificate_requirements(self):
        """Montre les exigences de certificats"""
